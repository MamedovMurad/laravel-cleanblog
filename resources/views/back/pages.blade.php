    ...
    <div class="col-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Meqaleler</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="topic" id="kategoriya" class="form-control">
                                    <option value="">idman </option>
                                    <option value="">gunluk heyatt</option>
                                    <option value="">texnalogiya</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea class="form-control" placeholder="Metn"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
